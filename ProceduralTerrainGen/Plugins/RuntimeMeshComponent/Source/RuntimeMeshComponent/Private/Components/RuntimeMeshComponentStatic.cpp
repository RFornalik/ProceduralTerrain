...
{
	StaticProvider->SetRenderableSectionAffectsCollision(SectionId, bCollisionEnabled,false);
}
...
{
	return StaticProvider->RemoveSection(LODIndex,SectionId);
}
...
void URuntimeMeshComponentStatic::MarkCollisionDirty()
{
	UE_LOG(LogTemp, Warning, TEXT("Called Collision Update From Component"));
